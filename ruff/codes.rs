...
pub fn code_to_rule(linter: Linter, code: &str) -> Option<(RuleGroup, Rule)> {
    ...
    Some(match (linter, code) {
        ...
        (Pylint, "E9001") => (RuleGroup::Preview, rules::pylint::rules::PyConDeprecatedTypingImport),
        (Pylint, "E9002") => (RuleGroup::Preview, rules::pylint::rules::PyConDeprecatedImport),
        (Pylint, "E9003") => (RuleGroup::Preview, rules::pylint::rules::PyConArgsWithoutType),
        (Pylint, "E9004") => (RuleGroup::Preview, rules::pylint::rules::PyConFunctionWithoutReturnDefinition),
        (Pylint, "E9100") => (RuleGroup::Preview, rules::pylint::rules::PyConAttributeError),
